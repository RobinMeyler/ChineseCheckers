...
struct Orientation
{
	...
	{}
	void operator==(Orientation t_orientation) { f0 = t_orientation.f0; f1 = t_orientation.f1, f2 = t_orientation.f2, f3 = t_orientation.f3, b0 = t_orientation.b0, b1 = t_orientation.b1, b2 = t_orientation.b2, b3 = t_orientation.b3, start_angle = t_orientation.start_angle; }
};
