#pragma once
// Code here described in: https://www.redblobgames.com/grids/hexagons/implementation.html
...
struct Orientation
{
    const double f0, f1, f2, f3; // matrix
    const double b0, b1, b2, b3; // inverse matrix
